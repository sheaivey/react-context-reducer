...
export default (config = { __useInProduction__: false }) => {
  if (!config.useInProduction && process.env.NODE_ENV === 'production') {
    // dont use in production... return dummy middleware.
